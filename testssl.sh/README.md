...
Due to Docker Hub now limiting the number of PATs that can be created, newer images can be found at the GHCR location: https://github.com/jauderho/dockerfiles/pkgs/container/testssl.sh
